...
namespace CameraLib
{
    ...
    public class CameraAnimator : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            cloudMat = cam.transform.GetChild(0).GetComponent<MeshRenderer>().material;
        }
        ...
        void Update()
        {
            ...
            cloudMat.SetFloat("_Progress", progress);
        }
        ...
        public void SetTarget(Vector3 pos)
        {
            ...
            // sequence.Append(DOTween.To(() => treeAroundRadius, (val) => {
            //     treeAroundRadius = val;
            // }, treeAroundRadius * 0.8f, 0.5f).SetEase(Ease.OutElastic));
            sequence.Append(DOTween.To(() => progress, (val) => {
                progress = val;
            }, 0f, 1f));
